    ...
    return (
      <div className="p-2 rounded-[2rem] bg-black/[0.03] dark:bg-white/[0.03] border border-black/[0.06] dark:border-white/[0.08]">
        <div className="flex flex-col items-center justify-center h-[460px] rounded-[calc(2rem-0.5rem)] bg-white dark:bg-[#111218] border border-black/[0.05] dark:border-white/[0.06] shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.06)] p-8 text-center select-none transition-colors">
          <div className="w-14 h-14 rounded-full bg-black/[0.04] dark:bg-white/[0.06] flex items-center justify-center text-zinc-600 dark:text-zinc-400 mb-4 border border-black/[0.04] dark:border-white/[0.08]">
            <Play className="w-5 h-5 ml-0.5" strokeWidth={1.5} />
          </div>
          <span className="rounded-full px-2.5 py-0.5 text-[10px] uppercase tracking-[0.2em] font-medium font-mono bg-zinc-100 dark:bg-white/[0.06] text-zinc-600 dark:text-zinc-400 mb-2">
            Offline Player
          </span>
          <h3 className="text-[16px] font-bold text-zinc-900 dark:text-white tracking-tight">No Lecture Selected</h3>
          <p className="text-[13px] text-zinc-600 dark:text-zinc-400 max-w-sm mt-1 leading-relaxed">
              ...
              >
                ...
                <div className="opacity-0 group-hover/pin:opacity-100 pointer-events-auto absolute -top-9 px-2 py-0.5 rounded-full bg-zinc-950/95 border border-amber-500/40 text-[10px] font-mono text-amber-300 whitespace-nowrap shadow-xl transition-opacity flex items-center gap-1.5 z-40">
                  ...
                  <button
                    ...
                    className="w-4 h-4 rounded-full hover:bg-rose-500/30 text-zinc-600 dark:text-zinc-400 hover:text-rose-400 flex items-center justify-center transition-colors"
                    title="Delete Pin"
                  >
              ...
              {isBoostMenuOpen && (
                <>
                  ...
                  <div id="audio-boost-popover" className="absolute left-0 bottom-full mb-2 w-56 rounded-2xl bg-zinc-950/95 backdrop-blur-2xl border border-white/15 shadow-2xl p-2.5 z-50 animate-in fade-in space-y-2 select-none">
                    <div className="flex items-center justify-between text-[10px] font-mono uppercase tracking-widest text-zinc-600 dark:text-zinc-400 px-1">
                    ...
                    <div className="text-[9px] text-zinc-600 dark:text-zinc-400 px-1 text-center font-mono">
              ...
              {isBookmarksMenuOpen && (
                <>
                  ...
                  >
                    ...
                    {bookmarks.length === 0 ? (
                      <div className="p-3 text-center text-[11px] text-zinc-600 dark:text-zinc-400 italic">
                        No pins dropped yet. Press <kbd className="font-mono text-zinc-600 dark:text-zinc-400">B</kbd> or click "+ Pin".
                      </div>
                    ) : (
                          ...
                          .map((bm) => (
                            ...
                            >
                              ...
                              <button
                                ...
                                className="p-1 rounded-lg hover:bg-rose-500/20 text-zinc-600 dark:text-zinc-400 hover:text-rose-400 opacity-60 group-hover/item:opacity-100 transition-all flex-shrink-0"
                                title="Delete pin"
                              >
                    ...
                    {bookmarks.length > 1 && (
                      <div className="pt-1.5 border-t border-white/10 flex justify-end">
                        <button
                          ...
                          className="text-[10px] text-zinc-600 dark:text-zinc-400 hover:text-rose-400 transition-colors flex items-center gap-1"
                        >
              ...
              {isLoopMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 bottom-full mb-2 w-52 rounded-2xl bg-zinc-950/95 backdrop-blur-2xl border border-white/15 shadow-2xl p-2.5 z-50 animate-in fade-in space-y-2">
                    <div className="text-[10px] font-mono uppercase tracking-widest text-zinc-600 dark:text-zinc-400 px-1">
                      A-B Looper Practice
                    </div>
                    ...
                    <div className="flex items-center gap-1.5 pt-1 border-t border-white/10">
                      ...
                      <button
                        ...
                        className="px-2 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 text-zinc-600 dark:text-zinc-400 hover:text-white text-[11px]"
